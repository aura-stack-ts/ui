...
export type FileUploadOptions = {
    ...
    maxFiles?: number
    /**
     * Defines the maximum file size in bytes, defaults to Infinity
     */
    maxSize?: number
    /**
     * File types to accept, defaults to "*".
     * @see https://developer.mozilla.org/en-US/docs/Web/HTML/Reference/Attributes/accept
     */
    accept?: string
    /**
     * If true, allows multiple files to be uploaded, defaults to false
     */
    multiple?: boolean
    initialFiles?: FileMetadata[]
    /**
     * Callback function that is called when the files change. It receives the current list of files as an argument.
     */
    onFilesChange?: (files: FileWithPreview[]) => void
    /**
     * Callback function that is called when new files are added. It receives the newly added files as an argument.
     */
