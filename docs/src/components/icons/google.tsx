...
export interface GoogleIconProps extends Omit<ComponentProps<"svg">, "width" | "height" | "color"> {
    size?: number | string
    color?: string
}

export const GoogleIcon = ({ size = 24, color = "currentColor", className, style, ...props }: GoogleIconProps) => {
    return (
        <svg
            width={size}
            height={size}
