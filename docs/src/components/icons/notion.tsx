...
export const NotionIcon = forwardRef<SVGSVGElement, NotionIconProps>(({ size = 24, className, ...props }, ref) => {
    return (
        <svg
            ref={ref}
