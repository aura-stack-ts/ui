...
export interface HubspotIconProps extends Omit<ComponentProps<"svg">, "width" | "height" | "color"> {
    size?: number | string
    color?: string
}

export const HubspotIcon = ({ size = 24, color = "currentColor", className, style, ...props }: HubspotIconProps) => {
    return (
        <svg
